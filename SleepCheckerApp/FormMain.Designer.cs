namespace SleepCheckerApp
{
    partial class FormMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            customLabel3.FromPosition = 3D;
            customLabel3.Text = "80";
            customLabel3.ToPosition = 5D;
            customLabel4.FromPosition = 5D;
            customLabel4.Text = "70";
            customLabel4.ToPosition = 7D;
            customLabel5.FromPosition = 7D;
            customLabel5.Text = "60";
            customLabel5.ToPosition = 9D;
            customLabel6.FromPosition = 9D;
            customLabel6.Text = "50";
            customLabel6.ToPosition = 11D;
            customLabel7.FromPosition = 11D;
            customLabel7.Text = "40";
            customLabel7.ToPosition = 13D;
            customLabel8.FromPosition = 13D;
            customLabel8.Text = "30";
            customLabel8.ToPosition = 15D;
            customLabel9.FromPosition = 15D;
            customLabel9.Text = "20";
            customLabel9.ToPosition = 17D;
            customLabel10.FromPosition = 17D;
            customLabel10.Text = "10";
            customLabel10.ToPosition = 19D;
            customLabel11.FromPosition = 19D;
            customLabel11.Text = "0";
            customLabel11.ToPosition = 21D;
